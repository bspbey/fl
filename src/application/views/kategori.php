...
<title><?php echo strip_tags($kategori_title); ?> | <?php echo strip_tags($ayarlar->site_title); ?></title>
...
<meta name="twitter:url" content="<?php echo base_url("kategori/".$kategori_url); ?>">
<meta name="twitter:title" content="<?php echo strip_tags($kategori_title); ?>">
...
<meta property="og:title" content="<?php echo strip_tags($kategori_title); ?>">
<meta property="og:site_name" content="<?php echo strip_tags($ayarlar->site_title); ?>">
<meta property="og:url" content="<?php echo base_url("kategori/".$kategori_url); ?>">
...
<img class="card-img-top" height="310" src="<?php echo base_url("uploads/$row->film_resim"); ?>" alt="<?php echo $film_baslik_v2; ?>...">
