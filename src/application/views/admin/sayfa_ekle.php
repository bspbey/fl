...
<i class="fa fa-file"></i> Sayfa Ekle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/sayfalar/ekle/insert"); ?>" method="post">
...
<input type="text" class="form-control" id="sayfa_baslik" name="sayfa_baslik">
</div>
<div class="form-group">
...
<textarea rows="5" class="form-control" id="sayfa_icerik" name="sayfa_icerik"></textarea>
</div>
<div class="form-group">
