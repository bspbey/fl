...
<div class="mr-5"><?php echo $istatistikler['film_sayisi']; ?> Film</div>
</div>
<a class="card-footer text-white clearfix small z-1" href="<?php echo base_url("admin/filmler"); ?>">
...
<div class="mr-5"><?php echo $istatistikler['film_goruntulenme']; ?> Film İzlenme Sayısı</div>
</div>
...
<!-- son filmler-->
<div class="mb-0 mt-4">
<i class="fa fa-newspaper-o"></i> Son eklenen filmler</div>
<hr class="mt-2">
...
<div class="card mb-2">
<div class="card-body">
<h6 class="card-title mb-1"><a target="_blank" href="<?php echo base_url("film/$row->film_url"); ?>"><?php echo $row->film_baslik; ?></a></h6>
<p class="card-text small"><?php echo substr(strip_tags($row->film_icerik), 0 , 250); ?>...</p>
</div>
</div>
<!-- son filmler -->
<?php } ?>
