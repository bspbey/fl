...
<li class="breadcrumb-item active">Film Botu</li>
</ol>
<div class="card mb-3">
<div class="card-header">Film bilgilerini bot ile getir (TMDB veritabanında bulunmayan filmlerde bilgileri lütfen el ile giriniz)
...
<div class="card-body">
<form action="<?php echo base_url("admin/film_botu/film_getir"); ?>" method="post">
<div class="form-group input-group mb-1">
<input type="text" class="form-control" name="film_tmdb_id" placeholder="TMDB film ID giriniz" aria-label="TMDB film ID giriniz" aria-describedby="basic-addon2">
<div class="input-group-append">
<button name="film_bilgi_getir" class="btn btn-sm btn-primary">Film bilgilerini getir :)</button>
</div>
</div>
</form>
</div>
