...
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Filmler">
<a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#filmler" data-parent="#acilir_menu">
<i class="fa fa-fw fa-film"></i>
<span class="nav-link-text">Filmler</span>
</a>
<ul class="sidenav-second-level collapse" id="filmler">
<li>
<a href="<?php echo base_url("admin/filmler"); ?>">Filmler</a>
</li>
<li>
<a href="<?php echo base_url("admin/film_kaynak"); ?>">Film Kaynakları(Embed)</a>
</li>
<li>
<a href="<?php echo base_url("admin/film-botu"); ?>">Film Botu</a>
</li>
</ul>
</li>
