...
<i class="fa fa-fw fa-align-justify"></i> Kategori Ekle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/kategoriler/ekle/insert"); ?>" method="post">
...
<input type="text" class="form-control" id="kategori_url" name="kategori_url">
</div>
<div class="form-group">
