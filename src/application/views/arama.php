...
<title><?php echo strip_tags($arama_title); ?> | <?php echo strip_tags($ayarlar->site_title); ?></title>
<meta name="author" content="Burak Dündar" />
<meta name="robots" content="all"/>
<meta name="description" content="<?php echo strip_tags($arama_description); ?>">
...
<meta name="twitter:url" content="<?php echo base_url("arama?q=".$q); ?>">
<meta name="twitter:title" content="<?php echo strip_tags($arama_title); ?>">
<meta name="twitter:description" content="<?php echo strip_tags($arama_description); ?>">
<meta name="twitter:image" content="<?php echo base_url("assets/images/bd.png"); ?>">
<meta property="og:locale" content="tr_TR">
<meta property="og:title" content="<?php echo strip_tags($arama_title); ?>">
<meta property="og:site_name" content="<?php echo strip_tags($ayarlar->site_title); ?>">
<meta property="og:url" content="<?php echo base_url("arama?q=".$q); ?>">
<meta property="og:image" content="<?php echo base_url("assets/images/bd.png"); ?>">
<meta property="og:image:width" content="150">
<meta property="og:image:height" content="150">
<meta property="og:description" content="<?php echo strip_tags($arama_description); ?>">
...
<div class="col-md-8">
<div class="my-4"></div>
<div class="container-fluid"><p class="alert alert-info"><?php echo $arama_title; ?></p></div>
