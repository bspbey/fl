...
<title>En Çok Beğenilenler | <?php echo strip_tags($ayarlar->site_title); ?></title>
...
<div class="col-md-8">
<p class="mt-4"></p>
<div class="container-fluid"><p class="alert alert-info">En Çok Beğenilen Filmler</p></div>
